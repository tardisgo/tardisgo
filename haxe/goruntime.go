...
var goruntime = `
// This Go code is used by the Haxe runtime, it must be entirely self-sufficent, with no external references as it can't be linked to from main go codebase.
