...
var res = map[string]string{
	" 5: *go/ast.File":       "the very first comment\npackage p\n",
	" 5: *go/ast.Ident":      " the name is p\n",
	" 8: *go/ast.GenDecl":    "imports\n",
	" 9: *go/ast.ImportSpec": "bytes\n",
	"10: *go/ast.ImportSpec": "fmt\n",
	"16: *go/ast.GenDecl":    "T\nalso associated with T\n",
	"17: *go/ast.Field":      "associated with a, b, c\n",
	"19: *go/ast.Field":      "associated with x, y\nfloat values\n",
	"20: *go/ast.Field":      "complex value\n",
	"25: *go/ast.GenDecl":    "x\nx = 0\nalso associated with x\n",
	"29: *go/ast.FuncDecl":   "f1\nassociated with f1\nalso associated with f1\n",
	"31: *go/ast.ExprStmt":   " associated with s1\nalso associated with s1\n",
	"37: *go/ast.ExprStmt":   "associated with s2\nalso associated with s2\nline comment for s2\n",
	"45: *go/ast.FuncDecl":   "associated with f2\nf2\n",
	"49: *go/ast.AssignStmt": "addition\n",
	"49: *go/ast.BasicLit":   " 1\n",
	"50: *go/ast.Ident":      "the very last comment\n",
} // haxe addidion of "go/" prefix
