...
var dot = []string{
	"dir_plan9.go","dir_unix.go","dir_windows.go",
	/* was:
	"dir_unix.go",
	"env.go",
	"error.go",
...
func TestStat(t *testing.T) {
	fmt.Println("TestStat() not run in Haxe as there are no system directories to read")
	return
...
func TestFstat(t *testing.T) {
	fmt.Println("TestFstat() not run in Haxe as there are no system directories to read")
	return
...
func TestLstat(t *testing.T) {
	fmt.Println("TestLstat() not run in Haxe as there are no system directories to read")
	return
...
func TestRead0(t *testing.T) {
	...
	path := "/temp.tmp" //Haxe addition
	ioutil.WriteFile(path, []byte{1,2,3}, 0666)//Haxe addition
...
func TestReaddirnamesOneAtATime(t *testing.T) {
	fmt.Println("TestReaddirnamesOneAtATime() not run in Haxe as there are no system directories to read")
	return
...
func TestReaddirStatFailures(t *testing.T) {
	//fmt.Println("TestReaddirStatFailures() not run in Haxe as there are no system directories to read")
	//return
...
func TestChdirAndGetwd(t *testing.T) {
	fmt.Println("TestChdirAndGetwd() not run in Haxe as there are no system directories to read")
	return
