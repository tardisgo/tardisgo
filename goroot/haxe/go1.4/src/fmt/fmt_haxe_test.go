...
var fmtTests = []struct {
	...
	{"%#v", SI{}, `fmt_test.SI{I:interface{}(nil)}`}, // tardisgo replacement line
	{"%#v", []int(nil), `[]int(nil)`},
	{"%#v", []int{}, `[]int{}`},
	...
	// tardisgo line above removed as not part of the language spec - TODO check
...
func TestPanics(t *testing.T) {
	for i, tt := range panictests {
		//println("DEBUG TestPanics:", tt.in)
		s := Sprintf(tt.fmt, tt.in)
		if s != tt.out {
